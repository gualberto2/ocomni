...
export default function HomePage() {
  return (
    <div className="min-h-screen min-w-screen px-10 lg:px-28 lg:h-screen overflow-hidden">
      ...
      <div className="mx-auto w-full h-full"> {/* THIS IS WHERE SVG IMG GOES */}
        <div className="">
          <div> {/* TRY TO ADD SVG IMG BELOW FOR RESPONSIVENESS */}
            <img src="" alt="home illistration" />
          </div> 
        </div>
      </div>
    </div>
