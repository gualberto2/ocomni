...
const Template = () => { {/* I created a projects class to contain objects of the img name and a cta for downloading the specific project...*/}
  const Templates = [
    {
    img: template1,
  ...
  return (
    <section id="templates" className="py-10 text-white">
      <div className="text-center">
        <h3 className="mt-2 text-black text-2xl font-semibold md:text-[2.8rem] lg:text-[3rem]">Free Templates</h3>
        <p className="text-black mt-3 text-lg"><span className="underline hover:cursor-pointer hover:text-decoration-line:none">Sign up</span> for a FREE template</p>
      </div>
      <br/>
          ...
          {Templates.map((Template_info, i) => (
            <SwiperSlide key={i}>
              <div className="h-fit w-full p-4 bg-white rounded-xl">
                <img src={Template_info.img} alt="downloadable template" className="rounded-lg"/>
